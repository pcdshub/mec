...
# =============================================================================
    ...
    def FixEdges(WavF,DurationListQ,StartStopListQ,CorrFactorFront=.97,CorrFactorBack=1.,PtNumFront=3,PtNumBack=2):
        """
...
# =============================================================================
    ...
    @classmethod
    def psefc10Hz(cls,pwt=0,numIterQ=50,AQQ=0.03,displayPlot=True,reloopPrompt=True,YFEbkgrdY=0,CorrFactorFront=.97,CorrFactorBack=1.0,PtNumFront=3,PtNumBack=2):
    ...
    def pssavewvfm(cls,RecipeStrQ=0,PsnsQ=0,SSsQ=0,YFEgetQ=0,TargetwlistDateQ='curr',TargetwindexQ=0,WvGoal10HzHint='none'):
        ...
        if TargetwlistDateQ == 'curr':
            ...
            wavehistQ=pickle.load(open(GLOBAL.PSFILEPATH+'w'+TargetwlistDateQ+'.p','rb'))
            NewWvfmQ=wavehistQ[TargetwindexQ][:]
            WvGoal10HzHint=WvGoal10HzHint+', w'+TargetwlistDateQ+'['+str(TargetwindexQ)+']'
    ...
    def psviewwvfm(cls,RecipeStrQ='none',TargetwlistDateQ='curr',TargetwindexQ=0,WvGoal10HzHint=False):
        ...
        if RecipeStrQ == 'none':
            if TargetwlistDateQ == 'curr':
                ...
                try:
                    wlastarr=pickle.load(open(GLOBAL.PSFILEPATH+'w'+TargetwlistDateQ+'.p','rb'))
                    slastarr=pickle.load(open(GLOBAL.PSFILEPATH+'s'+TargetwlistDateQ+'.p','rb'))
